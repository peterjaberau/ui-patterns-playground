...
const operators = ['===', '==', '!=', '>', '<', 'has', '!has']; // Supports four basic operators

// Calculate the hidden value of a single expression
...
export default (key: any, data: any, addons: any) => {
  ...
  // Description: It is a function expression
  if (

...
export const updateUserProfile: Fetcher<CommonResponse, { url: string; body: Record<string, any> }> = ({
  url,
  body,
}) => {
...
export const fetchMembers: Fetcher<{ accounts: Member[] | null }, { url: string; params: Record<string, any> }> = ({
  url,
  params,
}) => {
...
export const fetchProviders: Fetcher<Provider[] | null, { url: string; params: Record<string, any> }> = ({
  url,
  params,
}) => {
...
export const validateProviderKey: Fetcher<ValidateOpenAIKeyResponse, { url: string; body: { token: string } }> = ({
  url,
  body,
}) => {
...
export const updateProviderAIKey: Fetcher<
  ...
  { url: string; body: { token: string | ProviderAzureToken | ProviderAnthropicToken } }
> = ({ url, body }) => {
...
export const inviteMember: Fetcher<InvitationResponse, { url: string; body: Record<string, any> }> = ({
  url,
  body,
}) => {
...
export const updateMemberRole: Fetcher<CommonResponse, { url: string; body: Record<string, any> }> = ({
  url,
  body,
}) => {
...
export const fetchCurrentWorkspace: Fetcher<ICurrentWorkspace, { url: string; params: Record<string, any> }> = ({
  url,
  params,
}) => {
...
export const updateCurrentWorkspace: Fetcher<ICurrentWorkspace, { url: string; body: Record<string, any> }> = ({
  url,
  body,
}) => {
...
export const fetchWorkspaces: Fetcher<{ workspaces: IWorkspace[] }, { url: string; params: Record<string, any> }> = ({
  url,
  params,
}) => {
...
export const updateWorkspaceInfo: Fetcher<ICurrentWorkspace, { url: string; body: Record<string, any> }> = ({
  url,
  body,
}) => {
  return post<ICurrentWorkspace>(url, { body });
...
export const invitationCheck: Fetcher<
  CommonResponse & { is_valid: boolean; data: { workspace_name: string; email: string; workspace_id: string } },
  { url: string; params: { workspace_id?: string; email?: string; token: string } }
> = ({ url, params }) => {
  return get<
    CommonResponse & { is_valid: boolean; data: { workspace_name: string; email: string; workspace_id: string } }
  >(url, { params });
...
export const validateModelProvider: Fetcher<ValidateOpenAIKeyResponse, { url: string; body: any }> = ({
  url,
  body,
}) => {
  return post<ValidateOpenAIKeyResponse>(url, { body });
...
export const validateModelLoadBalancingCredentials: Fetcher<ValidateOpenAIKeyResponse, { url: string; body: any }> = ({
  url,
  body,
}) => {
  return post<ValidateOpenAIKeyResponse>(url, { body });
...
export const addApiBasedExtension: Fetcher<ApiBasedExtension, { url: string; body: ApiBasedExtension }> = ({
  url,
  body,
}) => {
...
export const updateApiBasedExtension: Fetcher<ApiBasedExtension, { url: string; body: ApiBasedExtension }> = ({
  url,
  body,
}) => {
  return post(url, { body }) as Promise<ApiBasedExtension>;
...
export const changePasswordWithToken: Fetcher<
  CommonResponse,
  { url: string; body: { token: string; new_password: string; password_confirm: string } }
...
export const sendDeleteAccountCode = () => get<CommonResponse & { data: string }>("/account/delete/verify");

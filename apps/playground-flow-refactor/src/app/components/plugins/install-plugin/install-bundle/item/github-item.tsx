...
const Item: FC<Props> = ({ checked, onCheckedChange, dependency, versionInfo, onFetchedPayload, onFetchError }) => {
  ...
  return <LoadedItem payload={payload} versionInfo={versionInfo} checked={checked} onCheckedChange={onCheckedChange} />;
};

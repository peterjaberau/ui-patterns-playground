...
import { useDSL, useNodesInteractions, usePanelInteractions, useWorkflowStartRun } from "./hooks";
...
const PanelContextmenu = () => {
  ...
  const panelMenu = useStore((s: any) => s.panelMenu);
  const clipboardElements = useStore((s: any) => s.clipboardElements);
  const setShowImportDSLModal = useStore((s: any) => s.setShowImportDSLModal);
  ...
  return (
    <div
      ...
      // @ts-ignore
      style={{ left: panelMenu.left, top: panelMenu.top }}
      ref={ref}
    >
      <div className="p-1">
        <AddBlock

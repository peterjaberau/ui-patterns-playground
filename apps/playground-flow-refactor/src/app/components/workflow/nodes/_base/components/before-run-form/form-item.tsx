...
import type { FileEntity } from "@/types/components/base/file-uploader/types";
    ...
    <div className={cn(className)}>
      ...
      <div className="grow">
        ...
        {type === InputVarType.singleFile && (
          <div>FileUploaderInAttachmentWrapper</div>
        ...
        {type === InputVarType.multiFiles && (
          <div>FileUploaderInAttachmentWrapper - multiple attachements</div>
          // <FileUploaderInAttachmentWrapper
          //   value={value}
        ...
        {type === InputVarType.files && (
          <div>TextGenerationImageUploader</div>

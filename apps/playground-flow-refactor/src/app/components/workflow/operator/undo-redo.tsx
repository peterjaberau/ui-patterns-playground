      ...
      <TipPopup title={t("workflow.common.undo")!} shortcuts={["ctrl", "z"]}>
        <div
          ...
          className={classNames(
            "flex items-center px-1.5 w-8 h-8 rounded-md system-sm-medium text-text-tertiary hover:bg-state-base-hover hover:text-text-secondary cursor-pointer select-none",

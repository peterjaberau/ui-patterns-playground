import type { CredentialFormSchemaBase } from '@/types/account/model-provider/declarations';
import type { ToolCredential } from '../tools/types';
import type { Locale } from '@/i18n';
import type { AgentFeature } from '@/types/components/workflow/nodes/agent/types';

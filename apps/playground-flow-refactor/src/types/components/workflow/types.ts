import type { Edge as ReactFlowEdge, Node as ReactFlowNode, Viewport } from '@xyflow/react';
...
import type {
  DefaultValueForm,
  ErrorHandleTypeEnum,
} from '@/types/components/workflow/nodes/_base/components/error-handle/types';
import type { WorkflowRetryConfig } from '@/types/components/workflow/nodes/_base/components/retry/types';
import type { StructuredOutput } from '@/types/components/workflow/nodes/llm/types';

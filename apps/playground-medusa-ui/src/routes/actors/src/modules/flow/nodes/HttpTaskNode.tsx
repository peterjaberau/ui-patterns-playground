            ...
            <div className="flex w-full max-w-xs flex-col">
              ...
              <Select
                ...
                onValueChange={(newValue: any) =>
                  machine.send('SET_TASK_SPECIFIC_PROPS', { value: { method: { raw: newValue, rich: newValue } } })
                }
              >
        ...
        test={
          <>
            ...
            <TextArea
              ...
              onValidJsonChange={(newJson) =>
                machine.send('SET_MOCK_RESPONSE', { value: { mockResponseData: newJson } })
              }
            />
          </>
        }

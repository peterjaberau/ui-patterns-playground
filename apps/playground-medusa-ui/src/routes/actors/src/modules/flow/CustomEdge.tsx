...
export const CustomEdge = ({
  ...
  const sourceTaskRunResult = useSelector(globalServices.workspaceService, (state: any) =>
    sourceTaskRunResultSelector(state, source),
  );
              ...
              <div className="flex h-full w-full items-center justify-center">
                <Popover>
                  <PopoverTrigger asChild>
                    <Button className="hover:bg-foreground group h-6 w-6 rounded-full p-0 transition-colors">
                      <CameraIcon className="group-hover:stroke-background h-4 w-4" />

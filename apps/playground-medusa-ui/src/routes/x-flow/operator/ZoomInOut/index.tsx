...
const ZoomInOut: FC = () => {
  ...
  return (
    <div className='fai-reactflow-zoominout'>
      <Tooltip title='Zoom out' getPopupContainer={() => document.getElementById('xflow-container') as HTMLElement}>
        <Button
          type='text'
      ...
      <Tooltip title='Zoom In' getPopupContainer={() => document.getElementById('xflow-container') as HTMLElement}>
        <Button
          type='text'

...
export const createActorReferenceContext = <TMachineReference extends ActorRef<any, any>>() => {
  const ActorReferenceContext = createContext<TMachineReference>(undefined as unknown as TMachineReference);

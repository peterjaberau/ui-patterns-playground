...
import { Variable02 } from '../../_icons/src/vender/solid/development';
  ...
  return (
    <div className="bg-workflow-process-bg flex w-[320px] flex-col items-start gap-2 rounded-[10px] p-4">
      <div className="flex h-10 w-10 items-center justify-center gap-2 rounded-[10px]">
        <div className="border-components-card-border bg-components-card-bg relative flex grow items-center justify-center gap-2 self-stretch rounded-[10px] border-[0.5px] p-1 shadow-lg">

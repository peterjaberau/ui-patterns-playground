    ...
    <>
      ...
      >
        ...
        <div className="mr-1 w-0 grow">
          <div className="system-xs-medium text-text-secondary mb-0.5 flex items-center truncate" title={file.name}>
        ...
        <div className="flex shrink-0 items-center">
          {progress >= 0 && !fileIsUploaded(file) && <ProgressCircle className="mr-2.5" percentage={progress} />}
          {progress === -1 && (

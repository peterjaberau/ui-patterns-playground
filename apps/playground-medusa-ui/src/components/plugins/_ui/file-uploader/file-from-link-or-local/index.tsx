...
import type { FileUpload } from '@plugins/_ui/features/types';
  ...
  return (
    <PortalToFollowElem placement="top" offset={4} open={open} onOpenChange={setOpen}>
      ...
      <PortalToFollowElemContent className="z-[1001]">
        <div className="border-components-panel-border bg-components-panel-bg-blur w-[280px] rounded-xl border-[0.5px] p-3 shadow-lg">
          {showFromLink && (
            <>
              <div
                className={cn(
                  'border-components-input-border-active bg-components-input-bg-active shadow-xs flex h-8 items-center rounded-lg border p-1',

...
import { LayoutGrid02 } from '@plugins/_icons/src/vender/line/layout';
      ...
      <TextEditor
        ...
        headerRight={
          <div className="flex h-[18px] items-center">
            <div className="flex cursor-pointer items-center space-x-1" onClick={handleSwitchToKeyValueEdit}>

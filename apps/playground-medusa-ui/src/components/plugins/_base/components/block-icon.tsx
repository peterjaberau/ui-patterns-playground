...
import {
  ...
  TemplatingTransform,
  VariableX,
} from '@plugins/_icons/src/vender/workflow';
import AppIcon from '@plugins/_ui/app-icon';
...
const BlockIcon: FC<BlockIconProps> = ({ type, size = 'sm', className, toolIcon }) => {
  return (
    <div
    ...
    >
      {type !== BlockEnum.Tool && getIcon(type, size === 'xs' ? 'w-3 h-3' : 'w-3.5 h-3.5')}

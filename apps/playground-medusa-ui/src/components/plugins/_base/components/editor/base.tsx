...
import { Clipboard, ClipboardCheck } from '@plugins/_icons/src/vender/line/files';
import useToggleExpend from '@/app/components/workflow/nodes/_base/hooks/use-toggle-expend';
import type { FileEntity } from '@plugins/_ui/file-uploader/types';
import FileListInLog from '@plugins/_ui/file-uploader/file-list-in-log';
    ...
    <Wrap className={cn(wrapClassName)} style={wrapStyle} isInNode={isInNode} isExpand={isExpand}>
      <div
        ...
        className={cn(
          ...
          'rounded-lg border',
          isFocus
            ? 'bg-components-input-bg-normal border-transparent'
            : 'border-components-input-border-hover bg-components-input-bg-hover overflow-hidden',
        )}
      >

...
export const WorkflowHistoryStoreContext = createContext<WorkflowHistoryStoreContextType>({
  store: null,
...
export function WorkflowHistoryProvider({ nodes, edges, children }: WorkflowWithHistoryProviderProps) {
...
export function useWorkflowHistoryStore() {
  ...
  if (store === null) throw new Error('useWorkflowHistoryStoreApi must be used within a WorkflowHistoryProvider');

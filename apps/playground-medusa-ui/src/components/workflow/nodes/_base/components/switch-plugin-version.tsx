...
import { Badge as Badge2, BadgeState } from '@/components/base/badge/index';
      ...
      <div className={cn('flex w-fit items-center justify-center', className)} onClick={(e) => e.stopPropagation()}>
          ...
          <PluginMutationModel
            ...
            modalBottomLeft={
              <Link
                ...
                target="_blank"
              >
                <span className="system-xs-regular text-text-accent text-xs">
        ...
        {pluginDetail && (
          <PluginVersionPicker
            ...
            trigger={
              <Badge
                className={cn('hover:bg-state-base-hover mx-1 flex', isShow && 'bg-state-base-hover')}
                uppercase={true}
                text={
                  <>

...
import { Clipboard, ClipboardCheck } from '@/components/base/icons/src/vender/line/files';
...
import CodeEditor from '@workflow/nodes/_base/components/editor/code-editor/editor-support-vars';
  ...
  return (
    <Wrap className={cn(className, wrapClassName)} style={wrapStyle} isInNode isExpand={isExpand}>
      <div
        ref={ref}
        className={cn(
          isFocus ? gradientBorder && s.gradientBorder : 'bg-gray-100',
          isExpand && 'h-full',
          '!rounded-[9px] p-0.5',
          containerClassName,
        )}
        ...
        >
          <div className={cn('flex items-center justify-between pl-3 pr-2 pt-1', headerClassName)}>
            <div className="flex gap-2">
              <div className={cn('text-xs font-semibold uppercase leading-4 text-gray-700', titleClassName)}>
              ...
              <div className="flex items-center space-x-[2px]">
                {isSupportJinja && (
                  ...
                  >
                    <div
                      className={cn(
                        editionType === EditionType.jinja2 && 'border-black/5 bg-white',

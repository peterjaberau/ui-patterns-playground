...
import { Agent } from '@/components/base/icons/src/vender/workflow';
    ...
    (schema, props) => {
      switch (schema.type) {
        ...
        case FormTypeEnum.textNumber: {
          ...
          if (!def.max || !def.min) return false;
          ...
          return (
            ...
            >
              <div className="flex w-[200px] items-center gap-3">
                <Slider value={value} onChange={onChange} className="w-full" min={def.min} max={def.max} />
                <InputNumber
                  value={value}
  ...
  return (
    <div className="space-y-2">
      ...
      {strategy ? (
        ...
        <ListEmpty
          icon={<Agent className="text-text-accent h-5 w-5 shrink-0" />}

...
import { useFileSizeLimit } from '@/components/base/file-uploader/hooks';
...
const FileUploadSetting: FC<Props> = ({
  ...
  return (
    <div>
      ...
      <Field title={t('appDebug.variableConfig.uploadFileTypes')} className="mt-4">
      ...
      {isMultiple && (
        <Field className="mt-4" title={t('appDebug.variableConfig.maxNumberOfUploads')!}>
          <div>
            <div className="body-xs-regular text-text-tertiary mb-1.5">
      ...
      {inFeaturePanel && !hideSupportFileType && (
        <Field title={t('appDebug.variableConfig.file.supportFileTypes')} className="mt-4">
          <div className="space-y-1">
            {[
              SupportUploadFileTypes.document,
              SupportUploadFileTypes.image,

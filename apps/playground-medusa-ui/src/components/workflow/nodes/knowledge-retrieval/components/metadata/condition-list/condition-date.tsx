...
import type { TriggerProps } from '@/components/base/date-and-time-picker/types';
      ...
      return (
        <div className="group flex items-center" onClick={handleClickTrigger}>
          ...
          {value && (
            <RiCloseCircleFill
              className={cn(
                'hover:text-components-input-text-filled hidden h-4 w-4 shrink-0 cursor-pointer group-hover:block',

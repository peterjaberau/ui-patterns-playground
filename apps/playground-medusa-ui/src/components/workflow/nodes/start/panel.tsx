...
import type { InputVar, NodePanelProps } from '@workflow/types';
    ...
    <div className="mt-2">
      <div className="space-y-4 px-4 pb-2">
        <Field
          ...
          operations={!readOnly ? <AddButton onClick={showAddVarModal} /> : undefined}
        >
          <>
            <VarList readonly={readOnly} list={inputs.variables || []} onChange={handleVarListChange} />
            ...
            <div className="mt-1 space-y-1">
              ...
              {isChatMode && (
                <VarItem
                  ...
                  rightContent={<div className="text-xs font-normal text-gray-500">String</div>}
                />
              )}
              ...
              <VarItem
                ...
                rightContent={<div className="text-xs font-normal text-gray-500">Array[File]</div>}
              />
              {isChatMode && (
                <>
                  <VarItem
                    ...
                    rightContent={<div className="text-xs font-normal text-gray-500">Number</div>}
                  />
                  <VarItem
                    readonly
                    payload={

...
import formatToTracingNodeList from '@workflow/run/utils/format-log';
  ...
  return (
    <div className="pt-2">
      {!readOnly && isShowAuthBtn && (
        <>
          <div className="px-4">
            <Button variant="primary" className="w-full" onClick={showSetAuthModal}>
      ...
      {!isShowAuthBtn && (
        <>
          <div className="space-y-4 px-4">
            ...
            {toolInputVarSchema.length > 0 && toolSettingSchema.length > 0 && <Split />}
      ...
      <div>
        <OutputVars>
          <>
            <VarItem name="text" type="String" description={t(`${i18nPrefix}.outputVars.text`)} />
            <VarItem name="files" type="Array[File]" description={t(`${i18nPrefix}.outputVars.files.title`)} />
            <VarItem name="json" type="Array[Object]" description={t(`${i18nPrefix}.outputVars.json`)} />

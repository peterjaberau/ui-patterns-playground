  ...
  return (
    <div className="group flex border-t border-gray-200">
      ...
      <div className="w-[120px] border-r border-gray-200">
        <input
          className="system-xs-regular placeholder:system-xs-regular text-text-secondary caret-primary-600 placeholder:text-components-input-text-placeholder hover:bg-state-base-hover focus:bg-components-input-bg-active block h-7 w-full appearance-none px-2 outline-none"

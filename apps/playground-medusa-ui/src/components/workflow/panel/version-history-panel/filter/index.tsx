...
const Filter: FC<FilterProps> = ({ filterValue, isOnlyShowNamedVersions, onClickFilterItem, handleSwitch }) => {
  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent className="z-[12]">
        <div className="border-components-panel-border bg-components-panel-bg-blur shadow-shadow-shadow-5 flex w-[248px] flex-col rounded-xl border-[0.5px] shadow-lg backdrop-blur-[5px]">

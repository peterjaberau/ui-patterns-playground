...
const VersionHistoryPanel = () => {
  ...
  return (
    <div className="border-components-panel-border bg-components-panel-bg shadow-shadow-shadow-5 flex w-[268px] flex-col rounded-l-2xl border-y-[0.5px] border-l-[0.5px] shadow-xl">
      <div className="flex items-center gap-x-2 px-4 pt-3">
        <div className="system-xl-semibold text-text-primary flex-1 py-1">{t('workflow.versionHistory.title')}</div>
        <Filter
                ...
                <div className="flex cursor-pointer items-center gap-x-1" onClick={handleNextPage}>
                  <div className="item-center flex justify-center p-0.5">
                    {isFetching ? (
                      ...
                      <RiArrowDownDoubleLine className="text-text-accent h-3.5 w-3.5" />
                    )}
                  </div>
                  <div className="system-xs-medium-uppercase text-text-accent py-[1px]">

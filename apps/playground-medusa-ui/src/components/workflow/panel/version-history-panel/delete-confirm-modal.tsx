...
const DeleteConfirmModal: FC<DeleteConfirmModalProps> = ({ isOpen, versionInfo, onClose, onDelete }) => {
  ...
  return (
    <Modal className="p-0" isShow={isOpen} onClose={onClose}>
      <div className="flex flex-col gap-y-2 p-6 pb-4">
        ...
        <p className="system-md-regular text-text-secondary">{t('workflow.versionHistory.deletionTip')}</p>
      </div>

...
import type { ChatItem, ChatItemInTree, Inputs } from '@/components/base/chat/types';
import type { InputForm } from '@/components/base/chat/chat/type';
import { getProcessedInputs, processOpeningStatement } from '@/components/base/chat/chat/utils';
...
import { getThreadMessages } from '@/components/base/chat/utils';
  ...
  const handleSend = useCallback(
    (
      ...
      handleRun(bodyParams, {
        ...
        onNodeStarted: ({ data }) => {
          if (data.iteration_id || data.loop_id) return;

...
import type { ChatItem, ChatItemInTree, OnSend } from '@/components/base/chat/types';
...
import { getLastAnswer, isValidGeneratedAnswer } from '@/components/base/chat/utils';
...
const ChatWrapper = ({
  ...
  return (
    <>
      ...
      />
      {showConversationVariableModal && (
        <ConversationVariableModal conversationID={conversationId} onHide={onConversationModalHide} />
      )}
    </>
  );
};

...
import type { ChatItem, ChatItemInTree } from '@/components/base/chat/types';
...
import { buildChatItemTree, getThreadMessages } from '@/components/base/chat/utils';
...
const ChatRecord = () => {
  ...
  return (
    <div
      className={`border-black/2 flex h-full w-[420px] flex-col rounded-l-2xl border shadow-xl`}
      style={{
        background:

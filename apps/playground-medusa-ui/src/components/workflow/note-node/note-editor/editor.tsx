...
const Editor = ({ placeholder = 'write you note...', onChange, containerElement }: EditorProps) => {
        ...
        contentEditable={
          <div>
            <ContentEditable
              ...
              spellCheck={false}
              className="text-text-secondary caret-primary-600 h-full w-full outline-none"
            />
          </div>
        }

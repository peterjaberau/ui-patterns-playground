    ...
    >
      <PortalToFollowElemTrigger onClick={() => !disabled && setOpen((v) => !v)}>
        ...
        >
          <div
            className={cn(
              'hover:bg-state-accent-hover group flex h-full w-full cursor-pointer items-center justify-center rounded-md',
                  ...
                  {needWarningNodes.map((node) => (
                    ...
                    >
                      <div className="flex h-9 items-center p-2 text-xs font-medium text-gray-700">
                        <BlockIcon type={node.type} className="mr-1.5" toolIcon={node.toolIcon} />

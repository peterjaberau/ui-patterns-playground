    ...
    >
                  ...
                  return (
                    ...
                    >
                      {headerGroup.headers.map((header, index) => {
                        ...
                        const isFirstHeader =
                          firstHeader !== -1 ? header.id === headerGroup.headers[firstHeader].id : index === 0;
                ...
                return (
                  ...
                  >
                    {cells.map((cell, index) => {
                      ...
                      const isFirstCell =
                        firstCell !== -1 ? cell.column.id === visibleCells[firstCell].column.id : index === 0;
                       ...
                       */
                      const depthOffset = row.depth > 0 && isFirstCell ? row.depth * 14 + 24 : undefined;
      ...
      {hasCommandBar && (
        <CommandBar open={!!Object.keys(rowSelection).length}>
          <CommandBar.Bar>
            <CommandBar.Value>`${Object.keys(rowSelection).length} selected`</CommandBar.Value>

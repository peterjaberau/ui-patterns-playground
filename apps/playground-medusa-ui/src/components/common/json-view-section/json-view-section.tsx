...
import { Badge, Container, Drawer, Heading, IconButton, Kbd, Text } from '@medusajs/ui';
  ...
  return (
    <Container className="flex items-center justify-between px-6 py-4">
      <div className="flex items-center gap-x-4">
        <Heading level="h2" className="text-black">
          JSON
        </Heading>
            ...
            <div className="flex items-center gap-x-4">
              <Drawer.Title asChild>
                <Heading className="text-ui-contrast-fg-primary">
                  {numberOfKeys === 1 ? `JSON · ${numberOfKeys} key` : `JSON · ${numberOfKeys} keys`}
                </Heading>
              </Drawer.Title>
                      ...
                      return (
                        <span className="text-ui-contrast-fg-secondary ml-2">
                          {Object.keys(value as object).length === 1
                            ? `${Object.keys(value as object).length} item`

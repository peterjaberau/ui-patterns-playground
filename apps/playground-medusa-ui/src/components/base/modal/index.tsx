        ...
        >
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            <TransitionChild>
              <DialogPanel
                className={classNames(
                  'bg-components-panel-bg w-full max-w-[480px] transform rounded-2xl p-6 text-left align-middle shadow-xl transition-all',
              ...
              >
                {title && (
                  <DialogTitle as="h3" className="title-2xl-semi-bold text-text-primary">
                    {title}
                  </DialogTitle>
                )}
                {description && <div className="body-md-regular text-text-secondary mt-2">{description}</div>}
                {closable && (

...
export const useOrderTableQuery = ({ prefix, pageSize = 20 }: UseOrderTableQueryProps) => {
  ...
  const { offset, sales_channel_id, created_at, updated_at, fulfillment_status, payment_status, region_id, q, order } =
    queryObject;

  const searchParams: HttpTypes.AdminOrderFilters | any = {
    limit: pageSize,

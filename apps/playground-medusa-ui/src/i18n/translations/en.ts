const translations = {
  ...
  products: {
    ...
    import: {
      ...
      upload: {
        ...
        description:
          'Through imports you can add or update products. To update existing products you must use the existing handle and ID, to update existing variants you must use the existing ID. You will be asked for confirmation before we import products.',
    ...
    media: {
      ...
      deleteWarningWithThumbnail_one:
        'You are about to delete {{count}} image including the thumbnail. This action cannot be undone.',
      deleteWarningWithThumbnail_other:
        'You are about to delete {{count}} images including the thumbnail. This action cannot be undone.',
  ...
  collections: {
    ...
    handleTooltip:
      'The handle is used to reference the collection in your storefront. If not specified, the handle will be generated from the collection title.',
    deleteWarning: 'You are about to delete the collection {{title}}. This action cannot be undone.',
    removeSingleProductWarning:
      'You are about to remove the product {{title}} from the collection. This action cannot be undone.',
    removeProductsWarning_one:
      'You are about to remove {{count}} product from the collection. This action cannot be undone.',
    removeProductsWarning_other:
      'You are about to remove {{count}} products from the collection. This action cannot be undone.',
    products: {
      list: {
  ...
  categories: {
    ...
    products: {
      ...
      remove: {
        ...
        confirmation_other:
          'You are about to remove {{count}} products from the category. This action cannot be undone.',
  ...
  giftCards: {
    ...
    expiryDateHint:
      'Countries have different laws regarding gift card expiry dates. Make sure to check local regulations before setting an expiry date.',
    regionHint:
      'Changing the region of the gift card will also change its currency, potentially affecting its monetary value.',
  ...
  customerGroups: {
    ...
    customers: {
      ...
      remove: {
        ...
        description_one:
          'You are about to remove {{count}} customer from the customer group. This action cannot be undone.',
        description_other:
          'You are about to remove {{count}} customers from the customer group. This action cannot be undone.',
      },
      list: {
  ...
  orders: {
    ...
    edits: {
      ...
      activeChangeError:
        'There is already active order change on the order (return, claim, exchange etc.). Please finish or cancel the change before editing the order.',
      panel: {
    ...
    returns: {
      ...
      noInventoryLevelDesc:
        'The selected location does not have an inventory level for the selected items. The return can be requested but can’t be received until an inventory level is created for the selected location.',
      ...
      activeChangeError:
        'There is an active order change in progress on this order. Please finish or discard the change first.',
      cancel: {
        title: 'Cancel Return',
      ...
      receive: {
        ...
        inventoryWarning:
          'Please note that we will automatically adjust the inventory levels based on your input above.',
        ...
        toast: {
          ...
          errorLargeDamagedValue:
            'Damaged items quantity + non damaged received quantity exceeds total item quantity on the return. Please decrease quantity of non damaged items.',
        },
      },
      toast: {
  ...
  draftOrders: {
    ...
    markAsPaid: {
      ...
      warningDescription:
        'You are about to mark the draft order as paid. This action cannot be undone, and collecting payment will not be possible later.',
    },
    status: {
      open: 'Open',
      completed: 'Completed',
  ...
  stockLocations: {
    ...
    fulfillmentProviders: {
      ...
      shippingOptionsTooltip:
        'This dropdown will only consist of providers enabled for this location. Add them to the location if the dropdown is disabled.',
    ...
    fulfillmentSets: {
      ...
      disable: {
        confirmation:
          'Are you sure that you want to disable {{name}}? This will delete all associated service zones and shipping options, and cannot be undone.',
    ...
    fields: {
      ...
      sublevels: {
        ...
        tooltips: {
          ...
          notPartOfCountry:
            '{{province}} does not appear to be part of {{country}}. Please double-check if this is correct.',
        },
        alert: {
          header: 'Sublevel regions are disabled for this tax region',
          description:
            'Sublevel regions are disabled for this region by default. You can enable them to create sublevel regions like provinces, states, or territories.',
      ...
      noDefaultRate: {
        ...
        tooltip:
          "This tax region does not have a default tax rate. If there is a standard rate, such as a country's VAT, please add it to this region.",
      },
    },
  },
  promotions: {
  ...
  priceLists: {
    ...
    products: {
      ...
      delete: {
        confirmation_one:
          'You are about to delete the prices for {{count}} product in the price list. This action cannot be undone.',
        confirmation_other:
          'You are about to delete the prices for {{count}} products in the price list. This action cannot be undone.',
  ...
  profile: {
    ...
    edit: {
      header: 'Edit Profile',
      languageHint:
        "The language you want to use in the admin dashboard. This doesn't change the language of your store.",
      languagePlaceholder: 'Select language',
      usageInsightsHint:
        'Share usage insights and help us improve Medusa. You can read more about what we collect and how we use it in our <0>documentation</0>.',
    },
    toast: {
  ...
  store: {
    ...
    removeCurrencyWarning_one:
      'You are about to remove {{count}} currency from your store. Ensure that you have removed all prices using the currency before proceeding.',
    removeCurrencyWarning_other:
      'You are about to remove {{count}} currencies from your store. Ensure that you have removed all prices using the currencies before proceeding.',
  ...
  regions: {
    ...
    removeCountriesWarning_one:
      'You are about to remove {{count}} country from the region. This action cannot be undone.',
    removeCountriesWarning_other:
      'You are about to remove {{count}} countries from the region. This action cannot be undone.',
    ...
    shippingOption: {
      ...
      availability: {
        ...
        adminOnlyHint:
          'When enabled, the shipping option will only be available in the admin dashboard, and not in the storefront.',
      },
  ...
  taxes: {
    ...
    settings: {
      ...
      calculateTaxesAutomaticallyHint:
        'When enabled, tax rates will be calculated automatically and applied to carts. When disabled, taxes must be manually computed at checkout. Manual taxes are recommended for usage with third-party tax providers.',
      applyTaxesOnGiftCardsLabel: 'Apply taxes on gift cards',
      applyTaxesOnGiftCardsHint:
        'When enabled, taxes will be applied to gift cards at checkout. In some countries, tax regulations require the application of taxes to gift cards upon purchase.',
  ...
  apiKeyManagement: {
    ...
    create: {
      ...
      secretKeyCreatedHint:
        'Your new secret key has been generated. Copy and securely store it now. This is the only time it will be displayed.',
    ...
    removeSalesChannel: {
      ...
      warningBatch_other:
        'You are about to remove {{count}} sales channels from the API key. This action cannot be undone.',
...
export const t = (target: string) => {
  return target.split('.').reduce((acc: any, key: any) => {
    return acc[key];
  }, translations);
};

...
import type { App } from '@workflow-app/types/app';
import type { ICurrentWorkspace, LangGeniusVersionResponse, UserProfileResponse } from '@workflow-app/models/common';
// import MaintenanceNotice from '@/app/components/header/maintenance-notice'
import type { SystemFeatures } from '@workflow-app/types/feature';
import { defaultSystemFeatures } from '@workflow-app/types/feature';
    ...
    >
      <div className="flex h-full flex-col overflow-y-auto">
        ...
        <div
          ...
          className="bg-background-body relative flex grow flex-col overflow-y-auto overflow-x-hidden"
        >
          {children}
        </div>
      </div>

...
// import AccountSetting from '@workflow-app/components/header/account-setting'
// import ApiBasedExtensionModal from '@/app/components/header/account-setting/api-based-extension-page/modal'
// import ModerationSettingModal from '@base/features/new-feature-panel/moderation/moderation-setting-modal';
// import ExternalDataToolModal from '@/app/components/app/configuration/tools/external-data-tool-modal'
// import AnnotationFullModal from '@/app/components/billing/annotation-full/modal'
// import ModelModal from '@workflow-app/components/header/account-setting/model-provider-page/model-modal'
...
import type { ModerationConfig, PromptVariable } from '@workflow-app/models/debug';
import type { ApiBasedExtension, ExternalDataTool } from '@workflow-app/models/common';
...
import OpeningSettingModal from '@base/features/new-feature-panel/conversation-opener/modal';
...
import { removeSpecificQueryParam } from '@utils/index';
...
export type ModelModalType = {
  currentProvider: any; //ModelProvider;
  currentConfigurationMethod: any; // ConfigurationMethodEnum;
  currentCustomConfigurationModelFixedFields?: any; // CustomConfigurationModelFixedFields;
};
export type LoadBalancingEntryModalType = ModelModalType & {
  entry?: any; // ModelLoadBalancingConfigEntry;
  index?: number;
};
...
export type ModalContextState = {
  ...
  setShowExternalKnowledgeAPIModal: Dispatch<SetStateAction<ModalState<any> | null>>;
  setShowModelLoadBalancingModal: Dispatch<SetStateAction<any | null>>;
  ...
  setShowOpeningModal: Dispatch<
    ...
    > | null>
  >;
  setShowUpdatePluginModal: Dispatch<SetStateAction<ModalState<any> | null>>;
};
...
export const ModalContextProvider = ({ children }: ModalContextProviderProps) => {
  ...
  const [showExternalKnowledgeAPIModal, setShowExternalKnowledgeAPIModal] = useState<ModalState<any> | null>(null);
  ...
  > | null>(null);
  const [showUpdatePluginModal, setShowUpdatePluginModal] = useState<ModalState<any> | null>(null);
  ...
  const handleCancelAccountSettingModal = () => {
    ...
    //
    // if (educationVerifying === 'yes') localStorage.removeItem(EDUCATION_VERIFYING_LOCALSTORAGE_ITEM);
    //
  ...
  return (
    ...
    >
      <>
        ...
        {/*   <AccountSetting activeTab={showAccountSettingModal.payload} onCancel={handleCancelAccountSettingModal} /> */}
        {/* )} */}
        ...
        {/*   <AnnotationFullModal show={showAnnotationFullModal} onHide={() => setShowAnnotationFullModal(false)} /> */}
        {/* )} */}
        {/* {!!showModelModal && ( */}
        {/*   <ModelModal */}
        ...
        {/*   /> */}
        {/* )} */}
        {/* {Boolean(showModelLoadBalancingModal) && <ModelLoadBalancingModal {...showModelLoadBalancingModal!} />} */}
        {/* {!!showModelLoadBalancingEntryModal && ( */}
        ...
        {/*     currentCustomConfigurationModelFixedFields={ */}
        {/*       showModelLoadBalancingEntryModal.payload.currentCustomConfigurationModelFixedFields */}
        {/*     } */}

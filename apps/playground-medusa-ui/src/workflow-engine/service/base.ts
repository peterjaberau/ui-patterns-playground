import { API_PREFIX, IS_CE_EDITION, PUBLIC_API_PREFIX } from '@workflow-app/config';
import { refreshAccessTokenOrRelogin } from './refresh-token';
import Toast from '@base/toast';
import type { AnnotationReply, MessageEnd, MessageReplace, ThoughtItem } from '@base/chat/chat/type';
import type { VisionFile } from '@workflow-app/types/app';
import type {
  AgentLogResponse,
...
import { removeAccessToken } from '@workflow-app/components/share/utils';

...
import type { BlockEnum, ConversationVariable, Edge, EnvironmentVariable, Node } from '@workflow/types';
import type { TransferMethod } from './app';
import type { ErrorHandleTypeEnum } from '@workflow/nodes/_base/components/error-handle/types';

...
import type { Edge, Node } from '@workflow/types';
import type { Metadata } from '@base/chat/chat/type';
...
export const fetchLogs = (url: string) => fetch(url).then<ConversationListResponse>((r) => r.json());

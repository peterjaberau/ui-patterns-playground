...
import type { AppIconType, AppMode, RetrievalConfig } from '@workflow-app/types/app';
import type { Tag } from '@base/tag-management/constant';
// import type { IndexingType } from '@/app/components/datasets/create/step-two';
import type { MetadataFilteringVariableType } from '@workflow/nodes/knowledge-retrieval/types';
import type { MetadataItemWithValue } from '@workflow-app/components/datasets/metadata/types';
...
export type DataSet = {
  ...
  indexing_technique: any; //IndexingType
  created_by: string;
  updated_by: string;
  updated_at: number;
  app_count: number;

...
const AgentLogModal: FC<AgentLogModalProps> = ({ currentLogItem, width, onCancel }) => {
  ...
  return (
    <div
      className={cn(
        'border-components-panel-border bg-components-panel-bg relative z-10 flex flex-col rounded-xl border-[0.5px] py-3 shadow-xl',
      )}
      style={{
        width: 480,
        position: 'fixed',
      ...
      ref={ref}
    >
      <h1 className="text-md text-text-primary shrink-0 px-4 py-1 font-semibold">

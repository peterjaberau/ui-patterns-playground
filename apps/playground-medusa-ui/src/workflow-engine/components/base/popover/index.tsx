          ...
          <>
            ...
            >
              <PopoverButton
                ...
                disabled={disabled}
                className={cn(
                  'border-components-button-secondary-border bg-components-button-secondary-bg hover:border-components-button-secondary-border-hover hover:bg-components-button-secondary-bg-hover group inline-flex items-center rounded-lg border px-3 py-2 text-base font-medium focus:outline-none',
              ...
              <Transition as={Fragment}>
                ...
                >
                  {({ close }) => (
                    ...
                    >
                      {cloneElement(
                        htmlContent as React.ReactElement,
                        {

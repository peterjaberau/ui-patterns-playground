...
import type {
  // AppData,
  ConversationItem,
} from '@workflow-app/models/share';
...
export const useEmbeddedChatbot = () => {
  ...
  //
  // useEffect(() => {
  //   if (appInfo?.site.default_language) changeLanguage(appInfo.site.default_language);
  // }, [appInfo]);
  //
  ...
  // const { data: appPinnedConversationData } = useSWR(['appConversationData', isInstalledApp, appId, true], () =>

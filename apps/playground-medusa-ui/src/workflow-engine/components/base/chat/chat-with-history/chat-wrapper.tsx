...
import InputsForm from '@base/chat/chat-with-history/inputs-form';
...
import SuggestedQuestions from '@base/chat/chat/answer/suggested-questions';
...
const ChatWrapper = () => {
  ...
  const chatNode = useMemo(() => {
    ...
    if (isMobile) {
      if (!currentConversationId) return <InputsForm collapsed={collapsed} setCollapsed={setCollapsed} />;
      return null;
    } else {
  ...
  const welcome = useMemo(() => {
    ...
    if (!collapsed && inputsForms.length > 0) return null;
        ...
        <div className="flex min-h-[50vh] items-center justify-center px-4 py-12">
          <div className="flex max-w-[720px] grow gap-4">
            ...
            <div className="w-0 grow">
              <div className="body-lg-regular bg-chat-bubble-bg text-text-primary grow rounded-2xl px-4 py-3">
  ...
  return (
    <div className="bg-chatbot-bg h-full overflow-hidden">
      <Chat
        appData={appData}
        config={appConfig}

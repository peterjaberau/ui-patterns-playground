...
import { RiEditBoxLine, RiExpandRightLine, RiLayoutLeft2Line } from '@remixicon/react';
import { useChatWithHistoryContext } from '../context';
import AppIcon from '@base/app-icon';
import ActionButton from '@base/action-button';
import Button from '@base/button';
import List from '@base/chat/chat-with-history/sidebar/list';
// import MenuDropdown from '@workflow-app/components/share/text-generation/menu-dropdown';
  ...
  return (
    <div
      className={cn(
        ...
        isPanel && 'border-components-panel-border-subtle bg-components-panel-bg rounded-xl border-[0.5px] shadow-lg',
      )}
    >

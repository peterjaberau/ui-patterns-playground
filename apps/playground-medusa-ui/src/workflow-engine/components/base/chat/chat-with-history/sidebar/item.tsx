...
import Operation from '@base/chat/chat-with-history/sidebar/operation';
...
const Item: FC<ItemProps> = ({ isPin, item, onOperate, onChangeConversation, currentConversationId }) => {
  ...
  return (
    <div
      ...
      key={item.id}
      className={cn(
        'system-sm-medium text-components-menu-item-text hover:bg-state-base-hover group flex cursor-pointer rounded-lg p-1 pl-3',

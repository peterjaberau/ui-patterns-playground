...
const ChatWithHistory: FC<ChatWithHistoryProps> = ({ className }) => {
  ...
  return (
    <div className={cn('bg-background-default-burn flex h-full', isMobile && 'flex-col', className)}>
      {!isMobile && (
        <div
          className={cn(
      ...
      <div className={cn('relative grow p-2', isMobile && 'h-[calc(100%_-_56px)] p-0')}>
        ...
        <div
          className={cn(
            'border-components-panel-border-subtle bg-chatbot-bg flex h-full flex-col overflow-hidden border-[0,5px]',
...
const ChatWithHistoryWrapWithCheckToken: FC<ChatWithHistoryWrapProps> = ({ installedAppInfo, className }) => {

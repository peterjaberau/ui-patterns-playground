...
import type { Annotation } from '@workflow-app/models/log';
...
export const useChat = (
  ...
  const handleSend = useCallback(
    async (
      ...
      //           (item.execution_metadata?.parallel_id === iterationFinishedData.execution_metadata?.parallel_id ||
      ...
      //         if (!item.execution_metadata?.parallel_id) return item.node_id === nodeFinishedData.node_id;
      //
      //         return (
      //           item.node_id === nodeFinishedData.node_id &&
      //           item.execution_metadata?.parallel_id === nodeFinishedData.execution_metadata?.parallel_id
      //         );
      //       });
      ...
      //           (item.execution_metadata?.parallel_id === loopFinishedData.execution_metadata?.parallel_id ||

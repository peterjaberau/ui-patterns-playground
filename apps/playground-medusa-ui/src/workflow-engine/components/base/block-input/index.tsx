...
import { varHighlightHTML } from '@workflow-app/components/app/configuration/base/var-highlight';
...
const BlockInput: FC<IBlockInputProps> = ({ value = '', className, readonly = false, onConfirm }) => {
  ...
  const textAreaContent = (
    <div
      className={classNames(readonly ? 'max-h-[180px] pb-5' : 'h-[180px]', 'overflow-y-auto')}

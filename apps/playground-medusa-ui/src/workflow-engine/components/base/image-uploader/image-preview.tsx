...
const ImagePreview: FC<ImagePreviewProps> = ({ url, title, onCancel, onPrev, onNext }) => {
  ...
  return createPortal(
    ...
    >
      ...
      />
      <Tooltip popupContent={'Copy Image'}>
        <div
      ...
      <Tooltip popupContent={'Open in new tab'}>
        <div

    ...
    <PortalToFollowElem open={open} onOpenChange={setOpen} placement="bottom-start" offset={4}>
      <div className="relative">
        ...
        <PortalToFollowElemContent className="z-[1002]">
          <div className="border-components-panel-border bg-components-panel-bg-blur relative w-[240px] rounded-lg border-[0.5px] shadow-lg backdrop-blur-[5px]">
            <div className="p-2">
              <Input
                showLeftIcon
                showClearIcon
            ...
            <div className="max-h-72 overflow-auto p-1">
              {filteredTagList.map((tag) => (
                ...
                >
                  <div title={tag.name} className="text-text-tertiary grow truncate text-sm leading-5">
                    {tag.name}
                  </div>

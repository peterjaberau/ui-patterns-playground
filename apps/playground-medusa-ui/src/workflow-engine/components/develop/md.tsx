  ...
  return (
    <>
      ...
      <div className="flex items-center gap-x-3">
        <span
          className={`rounded-lg px-1.5 font-mono text-[0.625rem] font-semibold leading-6 ring-1 ring-inset ${style}`}
        >
          {method}
        </span>
...
export function Col({ children, sticky = false }: IColProps) {
  return (
    <div className={classNames('[&>:first-child]:mt-0 [&>:last-child]:mb-0', sticky && 'xl:sticky xl:top-24')}>
      {children}
    </div>
  );
}

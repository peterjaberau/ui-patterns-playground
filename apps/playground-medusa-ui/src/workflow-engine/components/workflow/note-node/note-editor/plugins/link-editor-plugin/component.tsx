            ...
            {!linkOperatorShow && (
              <>
                <input
                  ...
                  autoFocus
                />
                <Button variant="primary" size="small" disabled={!url} onClick={() => handleSaveLink(url)}>
            ...
            {linkOperatorShow && (
              <>
                ...
                >
                  ...
                  <div className="mr-1">{t('workflow.nodes.note.editor.openLink')}</div>
                  <div title={escape(url)} className="text-text-accent max-w-[140px] truncate">
                    {escape(url)}
                  </div>
                </a>

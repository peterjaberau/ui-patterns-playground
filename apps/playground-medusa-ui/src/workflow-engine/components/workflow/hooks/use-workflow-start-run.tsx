...
import { useIsChatMode, useNodesSyncDraft, useWorkflowInteractions, useWorkflowRun } from './index';
...
export const useWorkflowStartRun = () => {
  ...
  const handleWorkflowStartRunInWorkflow = useCallback(async () => {
    ...
    const { showDebugAndPreviewPanel, setShowDebugAndPreviewPanel, setShowInputsPanel, setShowEnvPanel } =

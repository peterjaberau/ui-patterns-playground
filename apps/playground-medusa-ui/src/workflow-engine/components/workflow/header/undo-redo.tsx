      ...
      <TipPopup title={t('workflow.common.undo')!} shortcuts={['ctrl', 'z']}>
        <div
          ...
          className={classNames(
            'system-sm-medium text-text-tertiary hover:bg-state-base-hover hover:text-text-secondary flex h-8 w-8 cursor-pointer select-none items-center rounded-md px-1.5',

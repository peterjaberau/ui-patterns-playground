...
const IfElseNode: FC<NodeProps<IfElseNodeType>> = (props) => {
  ...
  const conditionNotSet = (
    <div className="bg-workflow-block-parma-bg text-text-secondary flex h-6 items-center space-x-1 rounded-md px-1 text-xs font-normal">
  ...
  return (
    <div className="px-3">
      ...
      <div className="relative flex h-6 items-center px-1">
        ...
        <NodeSourceHandle {...props} handleId="false" handleClassName="!top-1/2 !-right-[21px] !-translate-y-1/2" />
      </div>
    </div>
  );
};

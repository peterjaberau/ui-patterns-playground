      ...
      trigger={
        <div className="flex grow items-center justify-between pr-4">
          <div className="flex items-center">
            ...
            <Tooltip
              popupContent={<div className="w-[200px]">{t('workflow.nodes.knowledgeRetrieval.metadata.tip')}</div>}
            />
          </div>
          <div className="flex items-center">
            <MetadataFilterSelector value={metadataFilterMode} onSelect={handleMetadataFilterModeChangeWrapped} />
            {metadataFilterMode === MetadataFilteringModeEnum.manual && (
              <div className="ml-1">
    ...
    >
      <>
        {metadataFilterMode === MetadataFilteringModeEnum.automatic && (
          <>
            <div className="body-xs-regular text-text-tertiary px-4">

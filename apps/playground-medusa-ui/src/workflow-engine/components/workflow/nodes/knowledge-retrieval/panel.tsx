        ...
        <Field
          ...
          operations={
            <div className="flex items-center space-x-1">
              ...
              {!readOnly && <AddKnowledge selectedIds={inputs.dataset_ids} onChange={handleOnDatasetsChange} />}
            </div>
          }
        >
          <DatasetList list={selectedDatasets} onChange={handleOnDatasetsChange} readonly={readOnly} />
        </Field>
      </div>

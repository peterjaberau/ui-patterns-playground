...
import { LogicalOperator } from '@workflow/nodes/knowledge-retrieval/types';
...
const ConditionList = ({
  ...
  return (
    <div className={cn('relative')}>
      {conditions.length > 1 && (
        <div className={cn('absolute bottom-0 left-0 top-0 w-[44px]')}>
          <div className="border-divider-deep absolute bottom-4 right-1 top-4 w-2.5 rounded-l-[8px] border border-r-0"></div>

...
import { ToolTipContent } from '@base/tooltip/content';
    ...
    <Tooltip
      popupContent={
        <div className="space-y-1 text-xs">
          ...
          <p className="text-text-secondary tracking-tight">{description}</p>
          <p>
  ...
  return (
    <PortalToFollowElem open={open} onOpenChange={setOpen} placement="bottom">
      ...
      <PortalToFollowElemContent className="z-10">
        <div className="border-components-panel-border bg-components-panel-bg-blur w-[388px] overflow-hidden rounded-md border-[0.5px] shadow">

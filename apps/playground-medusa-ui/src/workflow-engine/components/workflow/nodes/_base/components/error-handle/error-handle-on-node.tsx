      ...
      <div
        className={cn(
          ...
          data._runningStatus === NodeRunningStatus.Exception &&
            'border-components-badge-status-light-warning-halo bg-state-warning-hover border-[0.5px]',
        )}
      >
        <div className="system-xs-medium-uppercase text-text-tertiary">{t('workflow.common.onFailure')}</div>
        <div
          className={cn(
        ...
        >
          ...
          {error_strategy === ErrorHandleTypeEnum.failBranch && t('workflow.nodes.common.errorHandle.failBranch.title')}
        </div>

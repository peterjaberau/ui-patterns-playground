      ...
      {processedList.map((item, index) => {
        ...
        return (
          <g key={index}>
            {index === 0 && (
              <>
                <path d="M0,18 L24,18" strokeWidth={1} fill="none" className="stroke-divider-solid" />
                <rect x={0} y={16} width={1} height={4} className="fill-divider-solid-alt" />
              </>
            )}
            {index > 0 && (
              <path
            ...
            <rect x={23} y={space} width={1} height={4} className="fill-divider-solid-alt" />
          </g>
        );
      })}
    </svg>

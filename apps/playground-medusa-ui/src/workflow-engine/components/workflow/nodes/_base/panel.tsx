  ...
  return (
    <div
      className={cn(
        ...
        showMessageLogModal &&
          'border-components-panel-border !absolute -top-[5px] right-[416px] z-0 !mr-0 w-[384px] overflow-hidden rounded-2xl border-[0.5px] shadow-lg transition-all',
      )}
    >
      <div ref={triggerRef} className="absolute -left-2 top-1/2 h-6 w-3 -translate-y-1/2 cursor-col-resize resize-x">
        <div className="bg-divider-regular h-6 w-1 rounded-sm"></div>
      </div>
      <div
        ref={containerRef}
        className={cn(
          'border-components-panel-border bg-components-panel-bg h-full rounded-2xl border-[0.5px] shadow-lg',
      ...
      >
          ...
          <div className="flex items-center px-4 pb-1 pt-4">
            ...
            <div className="flex shrink-0 items-center text-gray-500">
              {canRunBySingle(data.type) && !nodesReadOnly && (
                <Tooltip popupContent={t('workflow.panel.runThisStep')} popupClassName="mr-1">
                  <div
        ...
        {!!availableNextBlocks.length && (
          <div className="border-t-[0.5px] border-t-black/5 p-4">
            ...
            <div className="system-xs-regular text-text-tertiary mb-2">{t('workflow.panel.addNextStep')}</div>

...
const MemoryConfig: FC<Props> = ({
  ...
  const handleBlur = useCallback(() => {
    ...
    if (payload.window.size === '' || payload.window.size === null) handleWindowSizeChange(WINDOW_SIZE_DEFAULT);
  ...
  return (
    <div className={cn(className)}>
      <Field
        ...
        operations={
          <Switch defaultValue={!!payload} onChange={handleMemoryEnabledChange} size="md" disabled={readonly} />
        }
      >
        {payload && (
          <>

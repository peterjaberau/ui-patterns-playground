...
import type { NodeProps, Variable } from '@workflow/types';
import { isConversationVar, isENV, isSystemVar } from '@workflow/nodes/_base/components/variable/utils';
import { useIsChatMode, useWorkflow, useWorkflowVariables } from '@workflow/hooks';
          ...
          >
            <div className="flex items-center text-xs font-medium text-gray-500">
              {!isEnv && !isChatVar && (
                <>
                  <div className="p-[1px]">
                    <VarBlockIcon className="!text-gray-900" type={node?.data.type || BlockEnum.Start} />
                  </div>

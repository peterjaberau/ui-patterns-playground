  ...
  return (
    ...
    >
      <div className="flex w-0 grow items-center space-x-1">
        ...
        <div title={payload.variable} className="max-w-[130px] shrink-0 truncate text-[13px] font-medium text-gray-700">
          {payload.variable}
        </div>
        {payload.label && (
          <>
        ...
        {showLegacyBadge && (
          <Badge text="LEGACY" className="border-text-accent-secondary text-text-accent-secondary shrink-0" />
        )}
      </div>

    ...
    <div className="mt-2">
      <div className="space-y-4 px-4 pb-4">
        {!isEnableGroup ? (
          ...
          <div>
            ...
            <AddButton className="mt-2" text={t(`${i18nPrefix}.addGroup`)} onClick={handleAddGroup} />
          </div>
        )}
      </div>
      <Split />
      <div className={cn('px-4 pt-4', isEnableGroup ? 'pb-4' : 'pb-2')}>
        <Field
          ...
          operations={
            <Switch defaultValue={isEnableGroup} onChange={handleGroupEnabledChange} size="md" disabled={readOnly} />
          }
        />
      </div>
      {isEnableGroup && (

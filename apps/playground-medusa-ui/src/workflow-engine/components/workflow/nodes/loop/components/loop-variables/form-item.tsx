...
import type { LoopVariable } from '@workflow/nodes/loop/types';
import type { Var } from '@workflow/types';
import { ValueType, VarType } from '@workflow/types';
  ...
  return (
    <div>
      ...
      {value_type === ValueType.constant && var_type === VarType.string && (
        <Textarea value={value} onChange={handleInputChange} className="min-h-12 w-full" />
      )}

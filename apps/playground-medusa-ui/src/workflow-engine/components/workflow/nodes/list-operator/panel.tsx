...
import ExtractInput from '@workflow/nodes/list-operator/components/extract-input';
        ...
        >
          {inputs.order_by?.enabled ? (
            <div className="flex items-center justify-between">
              {hasSubVariable && (
                <div className="mr-2 grow">
                  <SubVariablePicker value={inputs.order_by.key as string} onChange={handleOrderByKeyChange} />
                </div>
              )}

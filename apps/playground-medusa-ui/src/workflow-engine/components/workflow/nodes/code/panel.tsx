...
import OutputVarList from '@workflow/nodes/_base/components/variable/output-var-list';
    ...
    <div className="mt-2">
      <div className="space-y-4 px-4 pb-4">
        ...
        <CodeEditor
          ...
          readOnly={readOnly}
          title={
            <TypeSelector options={codeLanguages} value={inputs.code_language} onChange={handleCodeLanguageChange} />
          }
      ...
      <div className="px-4 pb-2 pt-4">
        <Field title={t(`${i18nPrefix}.outputVars`)} operations={<AddButton onClick={handleAddOutputVariable} />}>
          <OutputVarList
            readonly={readOnly}

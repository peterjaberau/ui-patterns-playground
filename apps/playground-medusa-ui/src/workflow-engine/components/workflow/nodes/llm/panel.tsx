...
const Panel: FC<NodePanelProps<LLMNodeType>> = ({ id, data }) => {
  ...
  const handleModelChange = useCallback((model: { provider: string; modelId: string; mode?: string }) => {
    handleCompletionParamsChange({});
  ...
  return (
    <div className="mt-2">
      <div className="space-y-4 px-4 pb-4">
        ...
        {/* knowledge */}
        <Field title={t(`${i18nPrefix}.context`)} tooltip={t(`${i18nPrefix}.contextTooltip`)!}>
          <>
            <VarReferencePicker
              readonly={readOnly}
              nodeId={id}
        ...
        {isShowVars && (
          <Field
            ...
            operations={!readOnly ? <AddButton2 onClick={handleAddEmptyVariable} /> : undefined}
          >
            <VarList
              nodeId={id}
              readonly={readOnly}
          ...
          <div className="mt-4">
            <div className="flex h-8 items-center justify-between rounded-lg bg-gray-100 pl-3 pr-2">
              <div className="flex items-center space-x-1">
                ...
                <Tooltip popupContent={t('workflow.nodes.common.memories.tip')} triggerClassName="w-4 h-4" />
              </div>
              ...
              <Editor
                title={
                  <div className="flex items-center space-x-1">
                    ...
                    <Tooltip
                      popupContent={<div className="max-w-[180px]">{t('workflow.nodes.llm.roleDescription.user')}</div>}
      ...
      <OutputVars>
        <>
          <VarItem name="text" type="string" description={t(`${i18nPrefix}.outputVars.output`)} />
        </>
      </OutputVars>
      {isShowSingleRun && (
        <BeforeRunForm

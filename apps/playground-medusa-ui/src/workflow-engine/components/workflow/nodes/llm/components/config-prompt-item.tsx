      ...
      title={
        <div className="relative left-1 flex items-center">
          {payload.role === PromptRole.system ? (
            <div className="relative left-[-4px] text-xs font-semibold uppercase text-gray-700">SYSTEM</div>
          ) : (
            <TypeSelector
          ...
          <Tooltip
            popupContent={<div className="max-w-[180px]">{t(`${i18nPrefix}.roleDescription.${payload.role}`)}</div>}

...
const Item: FC<Props> = ({ payload, onEdit, onDelete }) => {
  return (
    <div className="hover:shadow-xs group relative rounded-lg border-[0.5px] border-gray-200 bg-white px-2.5 py-2">
      ...
      >
        <div className="cursor-pointer rounded-md p-1 hover:bg-black/5" onClick={onEdit}>
          <RiEditLine className="h-4 w-4 text-gray-500" />
        </div>

        <div className="cursor-pointer rounded-md p-1 hover:bg-black/5" onClick={onDelete}>

  ...
  return (
    <div className="pt-2">
      ...
      <div className="">
        <OutputVars>
          <>
            <VarItem name="body" type="string" description={t(`${i18nPrefix}.outputVars.body`)} />
            <VarItem name="status_code" type="number" description={t(`${i18nPrefix}.outputVars.statusCode`)} />
            <VarItem name="headers" type="object" description={t(`${i18nPrefix}.outputVars.headers`)} />
            <VarItem name="files" type="Array[File]" description={t(`${i18nPrefix}.outputVars.files`)} />
          </>
        </OutputVars>
      </div>
      {isShowSingleRun && (

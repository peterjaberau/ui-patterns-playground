...
const AllTools = ({
  ...
  const tools = useMemo(() => {
    ...
    if (activeTab === ToolTypeEnum.All) mergedTools = [...buildInTools, ...customTools, ...workflowTools];
    ...
    if (!hasFilter) return mergedTools.filter((toolWithProvider) => toolWithProvider.tools.length > 0);
  ...
  return (
    <div className={cn(className)}>
      <div className="border-divider-subtle bg-background-default-hover shadow-xs flex items-center justify-between border-b-[0.5px] px-3">

...
import AllTools from '@workflow/block-selector/all-tools';
...
import type { CustomCollectionBackend } from '@tools/types';
...
const ToolPicker: FC<Props> = ({
  ...
  return (
    <PortalToFollowElem placement={placement} offset={offset} open={isShow} onOpenChange={onShowChange}>
      <PortalToFollowElemTrigger onClick={handleTriggerClick}>{trigger}</PortalToFollowElemTrigger>

      <PortalToFollowElemContent className="z-[1000]">
        <div
          className={cn(
            'border-components-panel-border bg-components-panel-bg-blur relative min-h-20 w-[356px] rounded-xl border-[0.5px] shadow-lg backdrop-blur-sm',
            panelClassName,
          )}
        >

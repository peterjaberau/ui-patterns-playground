...
const AgentLogItem = ({ item, onShowAgentOrToolLog }: AgentLogItemProps) => {
  ...
  return (
    <div className="border-components-panel-border bg-background-default rounded-[10px] border-[0.5px]">
      <div
      ...
      >
        ...
        <BlockIcon className="mr-1.5 shrink-0" type={toolIcon ? BlockEnum.Tool : BlockEnum.Agent} toolIcon={toolIcon} />
        <div className="system-sm-semibold-uppercase text-text-secondary grow truncate" title={label}>
          {label}
        </div>
        {metadata?.elapsed_time && (
          <div className="system-xs-regular text-text-tertiary mr-2 shrink-0">

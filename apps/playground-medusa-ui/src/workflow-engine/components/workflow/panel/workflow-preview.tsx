...
const WorkflowPreview = () => {
  ...
  return (
    <div className={`flex h-full w-[420px] flex-col rounded-l-2xl border-[0.5px] border-gray-200 bg-white shadow-xl`}>
      ...
      <div className="relative flex grow flex-col">
        ...
        >
          {currentTab === 'INPUT' && showInputsPanel && <InputsPanel onRun={() => switchTab('RESULT')} />}
          {currentTab === 'RESULT' && (
            <>
              <ResultText
                isRunning={
          ...
          {currentTab === 'TRACING' && (
            <TracingPanel className="bg-background-section-burn" list={workflowRunningData?.tracing || []} />
          )}

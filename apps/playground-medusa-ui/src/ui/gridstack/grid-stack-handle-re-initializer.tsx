 ...
 */
export function GridStackHandleReInitializer(props: GridStackHandleReInitializerProps) {
  const {
  ...
  useLayoutEffect(() => {
    if (gridStack) {
      ...
      if (widgetContainer) {
        const element = Utils.getElement(widgetContainer.parentElement!) as GridItemHTMLElement & DDElementHost;

...
const SwrInitor = ({ children }: SwrInitorProps) => {
  ...
  const consoleToken = decodeURIComponent(searchParams.get("access_token") || "TMP_CONSOLE_TOKEN");
  const refreshToken = decodeURIComponent(searchParams.get("refresh_token") || "TMP_REFRESH_TOKEN");

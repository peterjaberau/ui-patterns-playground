import type { StrategyDetail, StrategyPluginDetail } from "@/types/components/plugins/types";
          ...
          schemas.forEach((schema: any) => {
            if (schema?.required) {
              if (schema.form === "form" && !userSettings[schema.name]?.value) {
                return {
                  isValid: false,
                  errorMessage: t("workflow.errorMsg.toolParameterRequired", {
              ...
              if (
                ...
                !userSettings[schema.name]?.value
              ) {
                return {
                  isValid: false,
                  errorMessage: t("workflow.errorMsg.toolParameterRequired", {

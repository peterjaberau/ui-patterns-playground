...
// import { usePublishWorkflow, useResetWorkflowVersionHistory } from "@/service/.mock-api/use-workflow";
import type { PublishWorkflowParams } from "@/types/workflow";
import { fetchAppDetail } from "@/service/.mock-api/apps";
...
const Header: FC = () => {
  ...
  }, [handleSyncWorkflowDraft, workflowStore, setShowWorkflowVersionHistoryPanel, t]);
    ...
    <div className="absolute left-0 top-0 z-10 flex h-14 w-full items-center justify-between bg-mask-top2bottom-gray-50-to-transparent px-3">
      ...
      {restoring && (
        <div className="flex items-center justify-end gap-x-2">
          ...
          <Button className="text-components-button-secondary-accent-text" onClick={handleCancelRestore}>
